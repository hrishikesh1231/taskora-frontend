...
export const indiaStatesDistricts = {
  ...
  ArunachalPradesh: [
    ...
    "Dibang Valley", "Anjaw", "Changlang", "Tirap", "Longding"
  ],
  ...
  Chhattisgarh: [
    ...
    "Kanker", "Korba", "Koriya", "Mahasamund", "Mungeli",
  ...
  Gujarat: [
    ...
    "Kutch", "Mahisagar", "Mehsana", "Morbi", "Narmada",
  ...
  Punjab: [
    ...
    "Mohali", "Muktsar", "Pathankot", "Patiala",
  ...
  TamilNadu: [
    ...
    "Tiruppur", "Tiruvallur", "Tiruvannamalai",
